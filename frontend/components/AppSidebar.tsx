 ...
 * 
 * Modern sidebar navigation with user profile, bugs, and projects sections.
 * Responsive design with collapsible behavior on desktop and mobile menu on small screens.
 */
...
export function AppSidebar({ children }: AppSidebarProps) {
  ...
  const links = [
    ...
    },
    {
      ...
      href: "/bugs",
      icon: (
        <IconBug className="h-5 w-5 shrink-0 text-neutral-700 dark:text-neutral-200" />
      ),
    },
    {
      label: "Projects",
  ...
  return (
    <div
      className={cn(
        "flex w-full flex-1 flex-col overflow-hidden bg-gray-50 md:flex-row dark:bg-neutral-900",
        "h-screen"
      )}
    >
